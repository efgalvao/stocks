...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference('Balance.count') do
      post balances_url, params: { balance: { account_id_id: @balance.account_id_id, balance: @balance.balance, date: @balance.date } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { account_id_id: @balance.account_id_id, balance: @balance.balance, date: @balance.date } }
